...
!function ($) {
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            ...
            this.options.paginationVAlign === 'top' || this.options.paginationVAlign === 'both' ?
                '<div class="fixed-table-pagination" style.css="clear: both;"></div>' :
                '',
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $.each(this.options.columns, function (i, column) {
            var text = '',
                halign = '', // header align style.css
                align = '', // body align style.css
                style = '',
            ...
            html.push('<div style.css="margin: 0px 2px 2px 2px;" class="filterControl">');
            ...
            if (column.filterControl !== undefined) {
                switch (column.filterControl.toLowerCase()) {
                    case 'input' :
                        html.push(sprintf('<input type="text" class="form-control" style.css="width: 100%; visibility: %s">', isVisible));
                        break;
                    case 'select':
                        html.push(sprintf('<select class="%s form-control" style.css="width: 100%; visibility: %s"></select>',
                            column.field, isVisible))
                        break;
                }
            } else {
                html.push('<div style.css="height: 34px;"></div>');
            }
    ...
    BootstrapTable.prototype.getCaretHtml = function () {
        return ['<span class="order' + (this.options.sortOrder === 'desc' ? '' : ' dropup') + '">',
            '<span class="caret" style.css="margin: 10px 5px;"></span>',
            '</span>'].join('');
    };
    ...
    BootstrapTable.prototype.resetFooter = function () {
        ...
        $.each(this.options.columns, function (i, column) {
            var falign = '', // footer align style.css
                style  = '',
                class_ = sprintf(' class="%s"', column['class']);
            ...
            html.push('<td', class_, sprintf(' style.css="%s"', falign + style), '>');
