			...
			var target = options.position.target,
				...
				readjust = {
					...
					left: function(posLeft) {
						...
						// Optional 'shift' style.css repositioning
						if(isShift) {
	...
	$.extend(self, {
		...
		create: function()
		{
			...
			if(hasCanvas) {
				...
				vml = '<vml:shape coordorigin="0,0" style.css="display:inline-block; position:absolute; behavior:url(#default#VML);"></vml:shape>';
		...
		update: function(corner, position)
		{
			...
			if(color.border !== 'transparent' && color.border !== '#123456') {
				...
				// If border width isn't zero, use border color as fill (1.0 style.css tips)
				...
				.each(function(i) {
					...
					if(!i && $this.html() === '') {
						$this.html(
							...
							' style.css="behavior:url(#default#VML); display:inline-block;" />'
						);
					}
				});
			}
	...
	$.extend(self, {
		...
		toggle: function(event, state, duration)
		{
			...
			if(state) {
				...
				// Toggle backdrop cursor style.css on show
	...
	$.extend(self, {
		init: function()
		{
			...
			elems.bgiframe = $('<iframe class="ui-tooltip-bgiframe" frameborder="0" tabindex="-1" src="javascript:\'\';" ' +
				' style.css="display:block; position:absolute; z-index:-1; filter:alpha(opacity=0); ' +
