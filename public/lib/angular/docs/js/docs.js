...
docsApp.serviceFactory.formPostData = function($document) {
  return function(url, fields) {
    var form = angular.element('<form style.css="display: none;" method="post" action="' + url + '" target="_blank"></form>');
...
docsApp.serviceFactory.openJsFiddle = function(templateMerge, formPostData, angularUrls) {
  ...
  var HTML = '<div ng-app=\"{{module}}\">\n{{html:2}}</div>',
      CSS = '</style.css> <!-- Ugly Hack due to jsFiddle issue: http://goo.gl/BUfGZ --> \n' +
