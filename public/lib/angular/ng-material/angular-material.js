  ...
  return Util = {
    ...
    floatingScrollbars: function() {
      if (this.floatingScrollbars.cached === undefined) {
        var tempNode = angular.element('<div style.css="width: 100%; z-index: -1; position: absolute; height: 35px; overflow-y: scroll"><div style.css="height: 60;"></div></div>');
 ...
 *
 * As per the [material design spec](http://www.google.com/design/spec/style.css/color.html#color-ui-color-application)
 ...
 *
 * @param {boolean=} md-inset Add this attribute to activate the inset divider style.css.
 * @usage
 * <hljs lang="html">
 ...
 *    style.css="width: 300px; height: auto; margin-right: 16px;" alt="Concept of grid explained visually">
 * <img src="//material-design.storage.googleapis.com/publish/v_2/material_ext_publish/0Bx4BSt6jniD7VGhsOE5idWlJWXM/components_grids_usage3.png"
 *    style.css="width: 300px; height: auto;" alt="Grid concepts legend">
 *
 ...
 * Fit rows:
 * <hljs lang="html">
 * <md-grid-list md-cols="4" md-row-height="fit" style.css="height: 400px;" ...>
 *   <md-grid-tile></md-grid-tile>
 * </md-grid-list>
 * </hljs>
 *
...
function GridListDirective($interpolate, $mdConstant, $mdGridLayout, $mdMedia) {
  ...
  function postLink(scope, element, attrs, ctrl) {
     ...
     * @returns {Object} Map of CSS properties to be applied to the style.css element. Will define
     *     values for top, left, width, height, marginTop, and paddingTop.
     */
    function getTileStyle(position, spans, colCount, rowCount, gutter, rowMode, rowHeight) {
      // TODO(shyndman): There are style.css caching opportunities here.
...
function GridLayoutFactory($mdUtil) {
  ...
  function GridLayout(colCount, tileSpans) {
      ...
      return self = {
         ...
         * signature:
         *
         *    function({grid: {element: JQLite, style.css: Object}, tiles: Array<{element: JQLite, style.css: Object}>)
         */
...
"use strict";
  ...
  /**
    ...
    *
    * @description
    * While `<md-icon />` markup can also be style.css with sizing CSS, this method configures
  ...
  return {
    ...
    compile: function(tEl, tAttrs) {
      ...
      function wrapIn(type) {
        var container;
        if (type == 'div') {
          container = angular.element('<div class="md-no-style.css md-list-item-inner">');
          container.append(tEl.contents());
          tEl.addClass('md-proxy-focus');
        } else {
          container = angular.element('<md-button class="md-no-style.css"><div class="md-list-item-inner"></div></md-button>');
      ...
      function postLink($scope, $element, $attr, ctrl) {
        ...
        function computeClickable() {
          if (proxies.length || hasClick) {
            ...
            ctrl.attachRipple($scope, angular.element($element[0].querySelector('.md-no-style.css')));
          }
        }
  ...
  function postLink(scope, element, attr, ngModelCtrl) {
    ...
    function redrawTicks() {
      ...
      if (!tickCanvas) {
        ...
        tickCanvas = angular.element('<canvas style.css="position:absolute;">');
...
"use strict";
   ...
   * <ul style.css="padding-left:20px;">
   *
   *   <ul>Style
   ...
   *     <li>hilighting style.css for invalid chips</li>
   *   </ul>
   *
   *   <ul>Item mutation
   *     <li>Support `
   ...
   * </ul>
   *
   *  <span style.css="font-size:.8em;text-align:center">
          ...
          <md-tabs-canvas\
            ...
            <md-pagination-wrapper\
              ...
              <md-tab-item\
                  tabindex="-1"\
                  class="md-tab"\
                  style.css="max-width: {{ tabWidth ? tabWidth + \'px\' : \'none\' }}"\
